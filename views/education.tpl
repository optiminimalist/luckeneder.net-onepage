<div class="featurette about_text">
    <p class="lead">

            <img class="about_text-image pull-left" src="./static/img/yelp_logo.png"/>

<span class="about_text_content text-middle">As of October 2013, I work as a <strong>Software Engineer</strong> at <a href="http://www.yelp.com">Yelp</a></span></p>
  </div>
